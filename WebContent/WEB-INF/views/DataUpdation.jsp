...
<div class="row">
	...
	<div class="col-md-8" style="margin:2%;padding:1%;background: #395444;">
		...
		<div class="container-fluid">
			...
			<form id="formToDisplay" style="display:none">
			    <div class="row">
			        <div class="col-md-6">
			            <select placeholder="10 class Board" ng-model="sscBoard" style="width:100%;height: 40px;" name="tenthboard" id="tenthboard">
			                <option label="-- Select option --" disabled selected="selected">Enter 10Th Board</option>
			                <option>SSC</option>
			                <option>CBSE</option>
			                <option>BSE</option>
			                <option>ICSE</option>
			        ...
			        <div class="col-md-6">
			            ...
			            <label for="tenthmarks"></label>
			        </div>
			    </div>
			    <div class="row">
			        <div class="col-md-6">
			            <select placeholder="11 & 12 class Board" ng-model="interBoard" style="width:100%;height: 40px;" name="interboard" id="interboard">
			                <option selected disabled>Enter Inter Board</option>
			                <option>Inter</option>
			                <option>CBSE</option>
			                <option>BSE</option>
			                <option>ICSE</option>
			        ...
			        <div class="col-md-6">
			            <input ng-model="interMaths" type="text" placeholder=" 11+12 Th Math Marks" name="intermarks"  id="intermarks"/>
			            <label for="intermarks"></label>
			        </div>
			    </div>
			    <div class="row">
			        <div class="col-md-6">
			            <input ng-model="fbLink" type="text" placeholder="Facebook link" name="fblink"  id="fblink"/>
			            <label for="fblink"></label>
			        </div>
			        <div class="col-md-6">
			            <input ng-model="lnLink" type="text" style="float:left;" placeholder=" Linkedin link" name="linkedin"  id="linkedin"/>
			            <label for="linkedin" style=""></label>
			        </div>
			    </div>
			    <div class="submit" style="width:30%;margin:auto;margin-top:5%;display:block;">
			        <button ng-click="saveMathsScore()" class="btn btn-default placemntBtns" style="padding: 3% 10% !important;">SAVE</button>
			    </div>
			 </form>  
			...
			<div id="notplacediv" style="display:none;">
				...
				<form>
					<div class="row">
			    		<div class="col-md-6">
			        		...
			        		<option ng-repeat="c in companies" ng-click="URL=c.URL; location=c.location" value="{{c.name}}"/>
			        		</datalist>
					...
					<div class="row">
						...
						<div class="col-md-2">
			    			<div  style="margin-top:6%;color:#fff;text-align:left;">
								<label class="checkbox"><input ng-true-value="'A'" ng-false-value="'NA'" ng-model="WrittenRound_Status" type="checkbox" style="width:15px;height:15px;" name="levewritten" id="levewritten" value=""> Written Test</label>
								<label class="checkbox"><input ng-true-value="'A'" ng-false-value="'NA'" ng-model="ComsRound_Status" type="checkbox" style="width:15px;height:15px;" name="f2ftexhlevel1" id="f2ftexhlevel1" value="">GD/JAM/Communication</label>
								<label class="checkbox"><input ng-true-value="'A'" ng-false-value="'NA'" ng-model="TechnicalRound1_Status" type="checkbox" style="width:15px;height:15px;" name="gdround" id="gdround" value=""> Technical Level 1</label>
								<label class="checkbox"><input ng-true-value="'A'" ng-false-value="'NA'" ng-model="TechnicalRound2_Status" type="checkbox" style="width:15px;height:15px;" name="jamround" id="jamround" value="">Technical Level 2</label>
								<label class="checkbox"><input ng-true-value="'A'" ng-false-value="'NA'" ng-model="HRRound_Status" type="checkbox" style="width:15px;height:15px;" name="jamround" id="jamround" value="">HR/Final Level</label>
							</div>
			    		</div>
			      ...
			      <div class="row">
			      	<div class="col-md-3">
			      		<h4 style="text-align:left;color:#fff;">Already Placed ?</h4>
			      	</div>
			      	<div class="col-md-2">
			      ...
			      <div ng-if="bond == 'YES'">
					  <div class="row" style="color:#fff">
					  	<div class="col-md-6">
					  		...
					  		<input ng-model="bondduration" type="text" placeholder="Bond Duration"/>
					  	</div>
					  	<div class="col-md-6">
				  ...
				  <div class="row">
		    		<div class="col-md-6">
		        		<input ng-model="initialSalary" type="text" placeholder="Enter Initial Salary" name="initialsal"  id="initialsal"/>
		        		<label for="initialSalary"></label>
		    		</div>
				    <div class="col-md-6">
				        <input ng-model="laterSalary" type="text" placeholder="Enter Later Salary (if Any)" name="latersal"  id="latersal"/>
				...
				<div class="row">
		    		<div class="col-md-6">
		        		...
		        		<label for="companydescr"></label>
		    		</div>
				    <div class="col-md-6">
				        <input ng-model="technicalStack" type="text" placeholder="Technical Stack / Role" name="companyurl"  id="companyurl"/>
				        <label for="companyurl"></label>
				    </div>
				</div>
				</div>
				 <div class="submit" style="width:30%;margin:auto;margin-top:5%;display:block;">
			        <button ng-click="saveDriveData()" class="btn btn-default placemntBtns" style="padding: 3% 10% !important;">SAVE</button>
			    </div>
				</form>               
			</div>
		</div>
    	...
    	//$scope.phoneNumber = "+919573883212";
    	  ...
    	  $scope.validateCode=function(){
    		...
    		function(response)
    		{
    			...
    			$scope.sendOTP();
    			document.getElementById("verifyButton").innerHTML="Checkout";
