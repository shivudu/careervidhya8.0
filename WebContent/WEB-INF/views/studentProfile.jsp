...
<head>
   ...
   <script type="text/javascript">
    ...
    var URL="http://localhost:8080/CareerVidhya_Operations8.0";
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg" color-on-scroll="500">
                <div class=" container-fluid " style="background-color:#000;color:#fff">
                    <div class="row"><div class="col-sm-4 col-md-4"><a class="navbar-brand" href="#" style="color:#fff;font-size:30px;font-family:monospace"> ${st.getFullName() }</a><p style="padding-top:5%">last active <i style="color:green" class="fas fa-dot-circle"></i>${st.getLastlogin() }</p></div><div class="col-sm-8 col-md-8"><p style="padding-top:3%"><a style="color:#fff;padding:2%" href="${st.getFbLink() }" target="_blank"><i class="fab fa-facebook-square"></i></a><a style="color:#fff;" href="${st.getLnLink() }" target="_blank"><i class="fab fa-linkedin"></i></a></p></div></div>
                </div>
            </nav>
            <!-- End Navbar -->
                ...
                <div class="container-fluid">
                    <div class="row" style="margin-bottom: 15px;">
                        <div class="col-md-2" style="background-color: #fff;">
                            ...
                            <p style="text-align: center; font-size: 60px!important; color:forestgreen; font-weight:700; margin-bottom: 0px;">${st.getBatchNumber() }</p>
                            <p style="text-align: center; font-size: 30px!important; font-weight:700; margin-bottom: 0px;">${st.getGraduationYOP() }</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                         ...
                         <div style="background-color: #fff;"><br><br>
                            <p style="text-align: center; font-size: 20px!important; color:forestgreen; margin-top: 10px; margin-bottom: 0px; font-weight: 500;">{{reports.length}}/{{totalExamsForBatch}} Exmas</p>
                            <p style="text-align: center; font-size: 60px!important; color:forestgreen; font-weight:700; margin-bottom: 0px;">{{avgScore}}%</p>
                        ...
                        <div class="col-md-1">
                          <div style="background-color: #fff;"><br><br>
                            <p style="text-align: center; font-size: 20px!important; color:forestgreen; margin-top: 10px; margin-bottom: 0px; font-weight: 500;">No of Walk-ins</p>
                            <p style="text-align: center; font-size: 60px!important; color:forestgreen; font-weight:700; margin-bottom: 0px;">{{driveData.length}}</p>
                    
                        </div>
                        </div>
                        
                        <div style="height:300px;" class="col-md-5 table-responsive">
                        ...
                        <td>{{d.name}}</td>
                        <td><i style="color:{{d.writtenRound_Status=='A'?'green':'red'}}" class="fas fa-circle"></i></td>
                        <td><i style="color:{{d.comsRound_Status=='A'?'green':'red'}}" class="fas fa-circle"></i></td>
                        <td><i style="color:{{d.technicalRound1_Status=='A'?'green':'red'}}" class="fas fa-circle"></i></td>
                        <td><i style="color:{{d.technicalRound2_Status=='A'?'green':'red'}}" class="fas fa-circle"></i></td>
                        <td><i style="color:{{d.hrround_Status=='A'?'green':'red'}}" class="fas fa-circle"></i></td>
                        <td>{{d.finalReport}}</td>
                        <td>
                        More
                        </td>
