...
<button class="btn btn-default viewStdBtns" style="width:12% !important;margin:0.5%" onclick="showFiltersStd()">Search Student</button>
<div class='container-fluid' id="filterIdStd" style="display:none;">
<div class='row'>
<div class='col-md-5'>
<p style='text-align:center;font-size:14px !important;font-weight:600;'>Search Student</p>
<div class='form-group col-md-4'>
<input type='text'  placeholder='Student Name' ng-model="studentName" style='height:28px !important;font-size:12px !important' class='form-control'></div>
<div class='form-group col-md-4'>
<select class='form-control' ng-model="yearOfPass" style='height:28px !important;font-size:12px !important'>
...
<select ng-model="branchName" class='form-control' style='height:28px !important;font-size:12px !important'>
...
<div class='form-group col-md-4'>
<select ng-model="graduationType" class='form-control' style='height:28px !important;font-size:12px !important'>
...
<div class='form-group col-md-4'>
<select ng-model="fee" class='form-control' style='height:28px !important;font-size:12px !important'>
...
<div class='form-group col-md-4'>
<select ng-model="genderI" class='form-control' style='height:28px !important;font-size:12px !important'>
<option value="" selected="selected">Gender</option>
<option value='male'>Male</option><option value='female'>Female</option></select></div></div>

<div class='col-md-5'><!-- <p style='text-align:center;font-size:14px !important;font-weight:600;'>Percentage</p> -->
<div class='row' style='margin-top:4% !important;'>
	<div class='col-md-3 col-sm-6'>
		<div class='checkbox' style='float:left;'>
			<label style="font-size:12px !important">Aggregation</label>
		</div>
	</div>
	<div class='col-md-3 col-sm-6'>
		<input ng-model="aggregate" type='range' id='rangeInput' name='rangeInput' style="width:80% !important;" min='0' max='100' value='0' oninput='amount.value=rangeInput.value'>
		<output name='amount' id='amount' for='rangeInput'>0</output>
	</div>
<div class='col-md-3 col-sm-6'>
<div class='checkbox' style='float:left;'>
<label style="font-size:12px !important">SSC</label></div>
</div><div class='col-md-3 col-sm-6'>
<input ng-model="SSC" type='range' id='rangeInput1' name='rangeInput1' min='0' style="width:80% !important;" max='100' value='0' oninput='amount1.value=rangeInput1.value'><output name='amount1' id='amount1' for='rangeInput1'>0</output></div></div>

<div class='row'>
<div class='col-md-3 col-sm-6'><div class='checkbox' style='float:left;'><label style="font-size:12px !important">Inter</label></div></div>

<div class='col-md-3 col-sm-6'><input ng-model="inter" type='range' style="width:80% !important;" id='rangeInput2' name='rangeInput2' min='0' max='100' value='0' oninput='amount2.value=rangeInput2.value'>
<output name='amount2' id='amount2' for='rangeInput2'>0</output>
</div><div class='col-md-3 col-sm-6'><div class='checkbox' style='float:left;'>
<label style="font-size:12px !important">
Degree</label></div></div>
<div class='col-md-3 col-sm-6'><input ng-model="degree" type='range' id='rangeInput3' style="width:80% !important;" name='rangeInput3' min='0' max='100' value='0' oninput='amount3.value=rangeInput3.value'>
...
<div class='container-fluid' style='height:430px;overflow:scroll;'><div class'row'><div class='col-md-12'> 
 		...
 		<td class='tdText'>{{t.feePaid}}<input class='form-control' type='number' style='display:none;border:1px solid #00a69c !important;' placeholder='Add fee' id='"+t.email+"Fee'/> <i class='fa fa-plus-square' aria-hidden='true'></i></td>
 		<td class='tdText'><span id='{{"feeUpdate_"+t.email}}'>{{t.feeTotal}}<i style='cursor:pointer;' ng-click='view.editFee(t.email)' class='fa fa-pencil-square' aria-hidden='true'></i></span></td>
 		<td class='tdText'>{{t.graduationYOP}}</td>
 		<td class='tdText'>{{t.aggregate}}</td>
 		<td style='font-size:12px !important;'><button  class='btn btn-default viewTableBtn'>View More Details</button></td>
 		<td style='font-size:12px !important;'><button  class='btn btn-default viewTableBtn'>View Progress</button></td>
...
<div class='col-md-6'><button ng-click="view.JSONToCSVConvertor()" class='btn btn-default viewStdBtns' style='float:right !important;'>Save To Excel</button></div>
</div></div><br>
...
<script>
	function showFiltersStd()
	{
		var searchStd=document.getElementById('filterIdStd');
		
		if(searchStd.style.display == 'none')
		{
			searchStd.style.display = 'block';
		}
		else
		{
			searchStd.style.display = 'none';
		}
	}
</script>	
	<script>
